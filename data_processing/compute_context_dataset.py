...
def get_context(path_water, path_wind, path_waves, path_bathy, init_lat, init_lon, init_time, name_file,saving_folder, d_context=1, npoints=32):
...
def compute_contexts_from_config_list_NOAA(path_configs, saving_path, saving_folder_context, set='train'):
    ...
    for data_file in tqdm(listdir,desc='Trajectories'):
        ...
        for i in range(len(drift_tab)-1):
            ...
            try:
                context_path = get_context(config['PATH_WATER'], config['PATH_WIND'],config['PATH_WAVES'],config['PATH_BATHY'],lat_init,lon_init,time_init,name_file,saving_folder_context,d_context, npoints)
            except:
                print('NotWorking')
                continue
...
if __name__ == "__main__": 
    path_configs = '../configs/configs_NOAA/val'
    saving_path = '../data/NOAA/nextpoint_ds/contexts/pt64d50/next_point_dataset_val.csv'
    saving_folder_context = '../data/NOAA/nextpoint_ds/contexts/pt64d50'
    set = 'val'
    ...
    path_configs = '../configs/configs_NOAA/train'
    saving_path = '../data/NOAA/nextpoint_ds/contexts/pt64d50/next_point_dataset_train.csv'
    saving_folder_context = '../data/NOAA/nextpoint_ds/contexts/pt64d50'
    set = 'train'
    ...
    path_configs = '../configs/configs_NOAA/test'
    saving_path = '../data/NOAA/nextpoint_ds/contexts/pt64d50/next_point_dataset_test.csv'
    saving_folder_context = '../data/NOAA/nextpoint_ds/contexts/pt64d50'
    set = 'test'
