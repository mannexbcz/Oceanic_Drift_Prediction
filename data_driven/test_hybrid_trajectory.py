...
def compute_nextpos_and_scores_hybrid(row, model):
    ...
    with open(row['CONFIG_PATH'], 'r') as f:
    ...
    row['Longitude_pred'], row['Latitude_pred'], row['d_pred'] =  lon_pred, lat_pred, dist_pred
...
if __name__ == "__main__": 
    ...
    module = TrajectoryModule.load_from_checkpoint(checkpoint_path)
    model = module.model
    model.eval()
